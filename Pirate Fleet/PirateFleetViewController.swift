...
// TODO:Uncomment once PenaltyCell protocol has been implemented
            ...
            // mine penalty
             if let mine = penaltyCell as? Mine {
                ...
                createAlertWithTitle(alertMessage, message: mine.penaltyText, actionMessage: Settings.Messages.DismissAction, completionHandler: { (action) in
            ...
            // seamonster penalty
                ...
                createAlertWithTitle(alertMessage, message: seamonster.penaltyText, actionMessage: Settings.Messages.DismissAction, completionHandler: { (action) in
                    self.dismissPenaltyAlert(player)
                })
            }
        } else {
