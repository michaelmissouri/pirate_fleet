...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You've hit a sea monster! This will result in an automatic hit... Sorry!"
        static let ComputerHitMonster = "The computer has hit a sea monster! Too bad... What are you going to do?"
